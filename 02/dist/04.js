	...
	_createClass(Slider, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(GoBack, { parentMethod: this.clickMethods.bind(this, 'red', 'green'), title: this.state.text })
			);
		}
	}]);
...
var GoBack = function (_Component2) {
	...
	_createClass(GoBack, [{
		...
		value: function childCallback() {
			...
			(_props = this.props).parentMethod.apply(_props, arg.concat([100, 200]));
		}
		// 渲染
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'span',
				{ onClick: this.childCallback.bind(this) },
				this.props.title
			);
		}
	}]);
