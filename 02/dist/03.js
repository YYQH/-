...
var Demo = function (_Component) {
	...
	function Demo(props) {
		...
		console.log('constructor', _this, arguments);
		// 初始化状态
		_this.state = {
			num: 100,
			// 将外部的数据，转化成内部的数据
	...
	_createClass(Demo, [{
		...
		value: function componentWillMount() {
			console.log('componentWillMount', this.state, this.props, arguments, (0, _reactDom.findDOMNode)(this));
		}
		// 4 渲染组件
		...
		value: function componentDidMount() {
			console.log('componentDidMount', this.state, this.props, arguments, (0, _reactDom.findDOMNode)(this));
		}
	}]);
