...
var Demo = function (_Component) {
	...
	_createClass(Demo, [{
		...
		key: 'changeUername',
		value: function changeUername(e) {
		...
		key: 'changeIntrest',
		value: function changeIntrest(intrest) {
			this.setState({
				intrest: intrest
			});
		}
		...
		value: function render() {
			...
			var _state = this.state,
			    ...
			    intrest = _state.intrest;

			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('input', { type: 'text', value: username, onChange: function onChange(e) {
						return _this2.changeUername(e);
					} }),
				_react2.default.createElement('input', { type: 'checkbox', checked: intrest, onChange: function onChange(e) {
						return _this2.setState({ intrest: e.target.checked });
					} }),
