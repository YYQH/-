	...
	_createClass(Slider, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(GoBack, { title: this.state.text })
			);
		}
		// 监听窗口的滚动
		// componentDidMount() {
...
var GoBack = function (_Component2) {
	...
	function GoBack(props) {
		...
		// 初始化
		var _this2 = _possibleConstructorReturn(this, (GoBack.__proto__ || Object.getPrototypeOf(GoBack)).call(this, props));
	...
	_createClass(GoBack, [{
		...
		value: function componentDidMount() {
			...
			window.onscroll = function () {
				// 如果滚动条距离顶部200,显示返回顶部
				if (window.scrollY > 200) {
					_this3.setState({ title: '返回顶部' });
					// 否则显示网址导航
				} else {
					_this3.setState({ title: '网址导航' });
				}
			};
		}
		// 定义事件回调函数
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'span',
				{ className: 'go-back', onClick: this.childCallback.bind(this) },
				this.state.title
			);
		}
		// 5 组件更新完毕
...
(0, _reactDom.render)(_react2.default.createElement(Slider, { text: '\u8FD4\u56DE\u9876\u90E82' }), app);
