...
var Demo = function (_Component) {
	...
	_createClass(Demo, [{
		key: 'createChildItem',
		value: function createChildItem(arr) {
			// 根据数组创建列表
		...
		value: function createList() {
			...
			return this.props.data.map(function (item, index) {
				...
				return _react2.default.createElement(
					'li',
					{ key: index, style: {
							display: index === _this2.state.num % len ? 'block' : 'none'
						} },
					_this2.createChildItem(item)
				);
			});
		}
		// 切换li
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'span',
					{ onClick: this.toggleLi.bind(this) },
					'\u6362\u4E00\u6362'
				),
				_react2.default.createElement(
					'ul',
...
(0, _reactDom.render)(_react2.default.createElement(Demo, { data: [['11岁身高2.06米'], ['大阪惊现神秘文字'], ['中国船队夺总冠军'], ['林心如晒素颜'], ['景区发布谢客令'], ['韩足协抗议FIFA']] }), app);
(0, _reactDom.render)(_react2.default.createElement(Demo, { data: [['2018国际禁毒日', '英美欧央行分歧'], ['小米集团出现抽飞', '罗志祥周扬青试婚'], ['深圳惊现龙吸水', '马拉多纳被送医院']] }), app2);
