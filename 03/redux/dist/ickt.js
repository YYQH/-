...
// 创建store
var store = (0, _redux.createStore)(redcer);

// 显示数据的组件

var ShowChild = function (_Component) {
	_inherits(ShowChild, _Component);

	function ShowChild() {
		_classCallCheck(this, ShowChild);

		return _possibleConstructorReturn(this, (ShowChild.__proto__ || Object.getPrototypeOf(ShowChild)).apply(this, arguments));
	}

	_createClass(ShowChild, [{
		key: 'render',
...
var ChangeChild = function (_Component2) {
	_inherits(ChangeChild, _Component2);

	function ChangeChild() {
		_classCallCheck(this, ChangeChild);

		return _possibleConstructorReturn(this, (ChangeChild.__proto__ || Object.getPrototypeOf(ChangeChild)).apply(this, arguments));
	}

	_createClass(ChangeChild, [{
		key: 'render',
		value: function render() {
			var _this3 = this;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ onClick: function onClick(e) {
							return _this3.props.dispatch({ type: ADD, num: 10 });
						} },
					'\u589E\u52A010'
				),
				_react2.default.createElement(
					'button',
					{ onClick: function onClick(e) {
							return _this3.props.reduceNum(2);
						} },
					'\u51CF\u5C112'
				)
			);
	...
	_createClass(App, [{
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    reduceNum = _props.reduceNum;

			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(ShowChild, { state: state }),
				_react2.default.createElement(ChangeChild, { dispatch: dispatch, reduceNum: reduceNum })
			);
		}
	}]);
...
function mapDispatchToProps(dispatch) {
	...
	return {
		dispatch: dispatch,
		// 定义方法
		reduceNum: function reduceNum(num) {
			// 构建消息对象
			dispatch({ type: REDUCE, num: num });
		}
	};
}
// 对app组件拓展
var DealApp = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(App);
