...
var Nav = function (_Component) {
	...
	_createClass(Nav, [{
		...
		value: function render() {
			// 返回值就是渲染的虚拟DOM
			return (0, _react.createElement)('ul', null,
			// 创建三个li虚拟DOM
			(0, _react.createElement)('li', null, '教你理财1'), (0, _react.createElement)('li', null, '天猫购物季1'), (0, _react.createElement)('li', null, '热门房源1'));
		}
	}]);
...
var nav = (0, _react.createElement)(Nav);
// 渲染虚拟DOM
(0, _reactDom.render)(nav, app);
// 实例化组件
var nav2 = (0, _react.createElement)(Nav);
// 渲染虚拟DOM
(0, _reactDom.render)(nav2, app2);
