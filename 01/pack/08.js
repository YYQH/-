	...
	_createClass(Demo, [{
		...
		value: function render() {
			...
			var divStyle = {
				background: 'green'
				// 设置内容
			};var html = '<a href="">安徽电信</a>';
			var html2 = '<a style="color: pink" href="">安徽电信</a>';
			// 返回值是渲染的结果
			return _react2.default.createElement(
				'div',
				{ style: divStyle, className: 'red' },
				_react2.default.createElement(
					'label',
					{ htmlFor: 'username', style: {
							color: 'red'
						} },
					'\u7528\u6237\u540D'
				),
				_react2.default.createElement('input', { id: 'username', ref: 'inp', type: 'text' }),
				_react2.default.createElement(
					'h1',
					null,
					html
				),
				_react2.default.createElement('h2', { dangerouslySetInnerHTML: {
						__html: html2
					} })
			);
		}
