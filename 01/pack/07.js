...
Nav.defaultProps = {
	data: ['默认数据']
	// 定义两组数据
};var arr1 = ['新浪新闻', '腾讯新闻', '百度新闻'];
var arr2 = ['淘宝网', '苏宁易购', '今日特价'];
// 渲染组件
(0, _reactDom.render)(_react2.default.createElement(Nav, { data: arr1 }), app1);
(0, _reactDom.render)(_react2.default.createElement(Nav, { data: arr2 }), app2);
(0, _reactDom.render)(_react2.default.createElement(Nav, null), app2);
